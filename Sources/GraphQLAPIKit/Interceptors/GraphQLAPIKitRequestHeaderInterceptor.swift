...
struct GraphQLAPIKitRequestHeaderInterceptor: InjectableInterceptor {
    let placement: InterceptorPlacement = .beforeNetworkFetch(priority: InterceptorPriority.high)
